...
interface DatesCookiesDetailProps {
  onBack: () => void;
  onInquire: (needsText: string) => void;
}

export default function DatesCookiesDetail({ onBack, onInquire }: DatesCookiesDetailProps) {
  ...
  const handleBeliSekarang = () => {
    onInquire("Halo Kalimaya, saya tertarik dengan produk Dates Cookies Alunna (Kukis Kurma Bebas Gluten & Rendah Gula) untuk kebutuhan pasokan / kemitraan ritel ritel B2B. Mohon info pricelist lengkap.");
  };

  const scrollToPelajari = () => {
    const element = document.getElementById("learn-cookies-section");
    if (element) {
    ...
    <div className="bg-[#FAF6EE] min-h-screen text-slate-800 font-sans overflow-x-hidden">
      ...
      <section className="relative bg-[#F3B033] text-white pt-24 pb-32 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Left Column: Dates Cookies Pack and Plate (Screenshot 1 left) */}
          <div className="lg:col-span-6 flex justify-center items-center relative py-6">
            ...
            >
              ...
              {/* Composite Image Mockup */}
              <div className="relative">
                {/* Floating cookies surrounding */}
                <motion.div 
                  animate={{ y: [0, -8, 0], rotate: [0, 5, 0] }}
                  transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                  className="absolute -left-12 top-1/4 w-16 h-16 z-20 hidden sm:block"
                >
                  <img src="https://images.unsplash.com/photo-1499636136210-6f4ee915583e?auto=format&fit=crop&q=80&w=150" alt="Cookie Decor" className="rounded-full w-full h-full object-cover shadow-md border-2 border-amber-200" referrerPolicy="no-referrer" />
                </motion.div>

                <motion.div 
                  animate={{ y: [0, 8, 0], rotate: [0, -6, 0] }}
                  transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
                  className="absolute -right-10 top-1/3 w-14 h-14 z-20 hidden sm:block"
                >
                  <img src="https://images.unsplash.com/photo-1558961309-dbdf0ddb20a0?auto=format&fit=crop&q=80&w=150" alt="Cookie Decor 2" className="rounded-full w-full h-full object-cover shadow-md border-2 border-amber-200" referrerPolicy="no-referrer" />
                </motion.div>

                {/* Main Package bag */}
                <img 
                  src="https://alunna.id/wp-content/uploads/2026/04/dates-cookies.webp" 
                  alt="Dates Cookies Alunna Premium Pack" 
                ...
                {/* Platter of ripe dates overlay at the bottom left */}
                <div className="absolute -bottom-4 -left-6 w-32 sm:w-40 z-20">
                  <img 
                    src="https://images.unsplash.com/photo-1569870499705-50e276842897?auto=format&fit=crop&q=80&w=300" 
                    alt="Whole dry dates plate" 
                    className="w-full h-auto rounded-full border-4 border-white/90 shadow-xl"
                    referrerPolicy="no-referrer"
                  />
          ...
          <div className="lg:col-span-6 text-center lg:text-left space-y-6 sm:space-y-8">
            <div className="space-y-4">
              ...
              >
                Nikmati Dates Cookies premium dengan rasa manis asli dari buah kurma. Pilihan camilan sehat, kaya serat, dan bebas rasa bersalah untuk menemani momen santai keluarga.
              </motion.p>
            </div>
      ...
      {/* SECTION 2: ARCHED COOKIE BENEFIT INFOGRAPHIC */}
      <section className="relative py-20 px-6 bg-[#FAF6EE] overflow-hidden" id="learn-cookies-section">
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-4 max-w-2xl mx-auto z-10 relative">
            ...
            >
              Cookies Kurma dengan Banyak Manfaat
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 15 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="relative pt-12 pb-24 md:pb-32 px-4 max-w-4xl mx-auto flex items-center justify-center">
            ...
            <div className="relative z-20 flex flex-col items-center justify-end mt-24">
              ...
              {/* Semi circle solid base and cookies plate image inside */}
              <div className="relative w-52 h-24 sm:w-72 sm:h-36 bg-[#F3B033] rounded-t-full flex items-center justify-center overflow-visible shadow-lg shadow-amber-500/10">
                ...
                >
                  <img 
                    src="https://images.unsplash.com/photo-1558961309-dbdf0ddb20a0?auto=format&fit=crop&q=80&w=400" 
                    alt="Premium Dates Cookies Plate illustration" 
                    className="w-full h-32 sm:h-44 object-cover rounded-2xl drop-shadow-[0_12px_24px_rgba(0,0,0,0.18)]"
                    referrerPolicy="no-referrer"
                  />
                </motion.div>
              </div>
            ...
            >
              ...
              <p className="text-[#8C593C] text-xs font-semibold leading-relaxed">
                Anak Memerlukan Energi untuk Beraktivitas
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8 md:hidden w-full px-4 text-center z-10 relative">
              ...
              <div className="bg-white p-4 rounded-xl border border-amber-100 shadow-sm space-y-1 text-[#8C593C]">
                ...
                <p className="text-xs">Anak Memerlukan Energi untuk Beraktivitas</p>
              </div>
              <div className="bg-white p-4 rounded-xl border border-amber-100 shadow-sm space-y-1 text-[#8C593C]">
      ...
      {/* SECTION 3: CORE CAPABILITIES & BENEFITS METADATA */}
      <section className="py-24 px-6 bg-[#FAF6EE] relative z-10">
        <div className="max-w-6xl mx-auto space-y-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center pt-8">
            ...
            {/* Left decor: Beautiful curved rounded blob with cookies package */}
            <div className="lg:col-span-5 flex justify-center relative">
              ...
              >
                <img 
                  src="https://alunna.id/wp-content/uploads/2026/04/dates-cookies.webp" 
                  alt="Dates Cookies Package illustration deep focus" 
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <div className="space-y-4">
                <h2 className="text-3xl sm:text-4xl font-sans font-black text-[#E3902D] uppercase tracking-wide">
                  Cookies Kurma yang Renyah dan Bergizi
                </h2>
                <div className="w-16 h-1 bg-[#8C593C] mx-auto lg:mx-0 rounded-full" />
              </div>

              <p className="font-sans text-slate-600 text-sm sm:text-base leading-relaxed">
                Diformulasikan khusus untuk mendukung tumbuh kembang si kecil serta menaikkan imunitas alami dengan kelezatan kukis premium renyah.
              </p>

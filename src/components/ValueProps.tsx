  ...
  const badges = [
    {
      ...
      b2bDesc: "Dibuat dari buah segar pilihan Nusantara tanpa tambahan perasa ataupun pewarna sintetis. Menyajikan rasa buah asli yang konsisten di setiap batch produksi untuk menyempurnakan resep bakery Anda.",
      color: "#085aa4",
      hoverColor: "#0072BB",
      icon: Leaf,
    },
    ...
    },
    {
      ...
      b2bDesc: "Kadar gula (Brix) terkontrol yang tidak mengorbankan kelezatan asli buah. Sangat ideal untuk industri baking sehat modern yang mengutamakan harmoni rasa premium dan kesehatan.",
      color: "#085aa4",
      hoverColor: "#0072BB",
      icon: Apple,
    }

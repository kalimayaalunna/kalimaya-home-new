...
interface DateSeedDrinkDetailProps {
  onBack: () => void;
  onInquire: (needsText: string) => void;
}

export default function DateSeedDrinkDetail({ onBack, onInquire }: DateSeedDrinkDetailProps) {
  ...
  const handleBeliSekarang = () => {
    onInquire("Halo Kalimaya! Saya sangat tertarik mendiskusikan pemesanan b2b / pembelian produk premium Date Seed Drink (Minuman Biji Kurma Bebas Kafein). Mohon informasi harga grosir.");
  };
  ...
  return (
    <div className="bg-[#FAF6EE] min-h-screen text-slate-800 font-sans overflow-x-hidden">
      ...
      {/* HEADER SECTION - SCROLL DEPENDENT ONLY */}
      ...
      <section className="relative bg-[#F3B033] text-white pt-24 pb-32 px-6 overflow-hidden">
        {/* Soft elegant cloud/bubble layout and subtle wave curves as shown on screenshot footer */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Left Column: Huge Floating Product Mockup package grouped with brew cup (Screenshot 1 left) */}
          <div className="lg:col-span-6 flex justify-center items-center relative py-6">
            ...
            >
              {/* Product composite shadow */}
              <div className="absolute -bottom-6 w-3/4 h-8 bg-black/15 blur-2xl rounded-full" />
              <img 
                src="https://alunna.id/wp-content/uploads/2026/04/date-seed-drink.webp" 
                alt="Date Seed Drink Premium Package and Brewing Drip" 
                className="w-full h-auto object-contain max-h-[350px] sm:max-h-[420px] drop-shadow-[0_24px_50px_rgba(140,88,60,0.3)] select-none hover:scale-[1.02] transition-transform duration-500"
        ...
        {/* Elegant screenshot layout bottom wave */}
      ...
      {/* SECTION 2: ARCHED COFFEE BENEFIT INFOGRAPHIC (MIMICKING SCREENSHOT 2) */}
      <section className="relative py-20 px-6 bg-[#FAF6EE] overflow-hidden" id="learn-more-section">
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-4 max-w-2xl mx-auto z-10 relative">
            ...
            >
              Minuman Biji Kurma Bebas Kafein
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 15 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Diformulasikan untuk orang yang mau mengurangi kafein tapi masih merasakan nikmatnya kopi
            </motion.p>
          </div>
          ...
          <div className="relative pt-12 pb-24 md:pb-32 px-4 max-w-4xl mx-auto flex items-center justify-center">
            ...
            <div className="relative z-20 flex flex-col items-center justify-end mt-24">
              ...
              {/* Semi circle solid base and Brewing Mug floating inside */}
              <div className="relative w-52 h-24 sm:w-72 sm:h-36 bg-[#F3B033] rounded-t-full flex items-center justify-center overflow-visible shadow-lg shadow-amber-500/10">
                <motion.div
                  ...
                  className="absolute bottom-4 sm:bottom-6 w-36 sm:w-56 h-auto z-30"
                >
                  <img 
                    src="https://alunna.id/wp-content/uploads/2026/04/date-seed-drink.webp" 
                    alt="Cup brewed" 
            ...
            >
              <div className="inline-flex items-center gap-2">
                <span className="font-sans font-black text-[#5D4037] text-md">Kaya Mineral</span>
              ...
              <p className="text-[#8C593C] text-xs font-semibold leading-relaxed">
                Penuhi nutrisi penting untuk tubuh
              </p>
            </motion.div>

            {/* Node 2: Bebas Kafein (Middle Left) */}
            <motion.div 
              initial={{ opacity: 0, y: -15 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="inline-flex items-center gap-2">
                <span className="font-sans font-black text-[#5D4037] text-md">Bebas Kafein</span>
                <span className="w-5 h-5 rounded-full bg-[#E3902D] border border-white flex-shrink-0 shadow-md ring-4 ring-[#FAF6EE] z-20" />
              </div>
              <p className="text-[#8C593C] text-xs font-semibold leading-relaxed">
                Aman dilambung dan jantung tidak berdebar
              </p>
            </motion.div>

            {/* Node 3: Tinggi Serat (Middle Right) */}
            <motion.div 
              initial={{ opacity: 0, y: -15 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="inline-flex items-center gap-2">
                <span className="w-5 h-5 rounded-full bg-[#E3902D] border border-white flex-shrink-0 shadow-md ring-4 ring-[#FAF6EE] z-20" />
                <span className="font-sans font-black text-[#5D4037] text-md">Tinggi Serat</span>
              </div>
              <p className="text-[#8C593C] text-xs font-semibold leading-relaxed">
                Membantu melancarkan sistem pencernaan harian
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8 md:hidden w-full px-4 text-center z-10 relative">
              <div className="bg-white p-4 rounded-xl border border-amber-100 shadow-sm space-y-1 text-[#8C593C]">
                ...
                <h4 className="font-sans font-black text-slate-800 text-sm">Kaya Mineral</h4>
                <p className="text-xs">Penuhi nutrisi penting untuk tubuh</p>
              </div>
              <div className="bg-white p-4 rounded-xl border border-amber-100 shadow-sm space-y-1 text-[#8C593C]">
                ...
                <h4 className="font-sans font-black text-slate-800 text-sm">Bebas Kafein</h4>
                <p className="text-xs">Aman dilambung dan jantung tidak berdebar</p>
              </div>
              <div className="bg-white p-4 rounded-xl border border-amber-100 shadow-sm space-y-1 text-[#8C593C]">
                ...
                <h4 className="font-sans font-black text-slate-800 text-sm">Tinggi Serat</h4>
                <p className="text-xs">Membantu melancarkan sistem pencernaan harian</p>
              </div>
              <div className="bg-white p-4 rounded-xl border border-amber-100 shadow-sm space-y-1 text-[#8C593C]">
                ...
                <p className="text-xs">Melindungi tubuh dari radikal bebas</p>
              </div>
            </div>
      ...
      <section className="py-24 px-6 bg-[#FAF6EE] relative z-10">
        <div className="max-w-6xl mx-auto space-y-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="space-y-3 mt-4">
                ...
                <p className="text-amber-50 text-xs sm:text-sm leading-relaxed font-sans">
                  Kaya mineral penting untuk dukung kesehatan saraf dan fungsi kognitif.
                </p>
              </div>
            </motion.div>

            {/* Card 2: Immune System */}
            <motion.div 
              initial={{ opacity: 0, y: 15 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              ...
              className="bg-[#F3B033] text-white rounded-3xl p-8 pt-10 text-center relative shadow-lg shadow-amber-500/5 override-margin-none-complex"
            >
              ...
              <div className="space-y-3 mt-4">
                ...
                <p className="text-amber-50 text-xs sm:text-sm leading-relaxed font-sans">
                  Tinggi antioksidan alami yang bantu lindungi tubuh dari radikal bebas.
                </p>
              </div>
            </motion.div>

            {/* Card 3: Natural Energy */}
            <motion.div 
              initial={{ opacity: 0, y: 15 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <div className="space-y-3 mt-4">
                ...
                <p className="text-amber-50 text-xs sm:text-sm leading-relaxed font-sans">
                  Berikan dorongan stamina harian yang aman tanpa efek samping kafein.
                </p>
              </div>
            </motion.div>
          ...
          {/* Lower layout: Symmetrical banner layout (Screenshot 3 bottom row) */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center pt-8">
            
            {/* Left decor: Beautiful curved rounded blob with brewing coffee cup */}
            ...
            {/* Right: Premium brand values text explanation (Screenshot 3 bottom details) */}
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <div className="space-y-4">
                <h2 className="text-3xl sm:text-4xl font-sans font-black text-[#E3902D] uppercase tracking-wide">
                  Kaya Manfaat dan Rasanya Enak
                </h2>
                <div className="w-16 h-1 bg-[#8C593C] mx-auto lg:mx-0 rounded-full" />
              </div>

              <p className="font-sans text-slate-600 text-sm sm:text-base leading-relaxed">
                Bebas kafein yang membuat jantung berdebar untuk orang yang tidak kuat dengan kafein.
              </p>
              ...
              <div className="pt-4 flex flex-wrap justify-center lg:justify-start gap-3">
                <span className="px-3.5 py-1.5 rounded-full bg-white border border-[#E3902D]/20 text-[#8C593C] text-xs font-bold font-sans shadow-sm inline-flex items-center gap-1.5">
                  ...
                  Pre-mix Quality Blend
                </span>
                <span className="px-3.5 py-1.5 rounded-full bg-white border border-[#E3902D]/20 text-[#8C593C] text-xs font-bold font-sans shadow-sm inline-flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#E3902D]" />
                  Sourcing Biji Kurma Segar
                </span>
                <span className="px-3.5 py-1.5 rounded-full bg-white border border-[#E3902D]/20 text-[#8C593C] text-xs font-bold font-sans shadow-sm inline-flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#E3902D]" />
                  Halal & BPOM RI standard
                </span>
              </div>
